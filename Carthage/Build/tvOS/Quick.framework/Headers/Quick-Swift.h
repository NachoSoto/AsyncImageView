...
/// \param block A block that takes a QuickConfiguration.Type.
/// This block will be executed once for each subclass of QuickConfiguration.
///
+ (void)enumerateSubclasses:(SWIFT_NOESCAPE void (^ _Nonnull)(SWIFT_METATYPE(QuickConfiguration) _Nonnull))block;
@end
